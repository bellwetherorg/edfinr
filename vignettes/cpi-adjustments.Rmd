...
- **Debt and fund-balance stocks** (`debt_*`, `fund_bal_*`). These are balance-sheet levels measured at a point in time, not annual flows, so deflating them with a flow price index would be incorrect. They are always returned in nominal dollars.
