...
- Detailed capital outlay, debt stocks, and fund balances (see the "Capital and Facilities" vignette).
- The CWIFT standard error and imputation method (see the "CWIFT" vignette).
...
# view detailed expenditure, capital, debt, and CWIFT variables in the full dataset
names(ky_full_sy16)[53:121]
```
...
- See the "Capital and Facilities" vignette for working with capital outlay, debt, and fund balances.
- See the "CWIFT" vignette for working with the Comparable Wage Index for Teachers.
