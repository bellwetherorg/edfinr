...
list_variables <- function(dataset_type = "skinny", category = "all") {
  ...
  all_variables <- tibble::tribble(
    ...
    "exp_cur_pp", "numeric", "expenditure", "NCES F-33 Survey", "(CE1 + CE2 + CE3) / V33", "2016", "Current expenditure per-pupil (CE1 + CE2 (+ CE3 when available) divided by V33)", "skinny",
    ...
    "rev_exp_pp_diff", "numeric", "expenditure", "NCES F-33 Survey", NA, "2016", "Revenue minus expenditure per-pupil", "skinny",
    "exp_cur_st_loc", "numeric", "expenditure", "NCES F-33 Survey", "CE1", "2016", "Current expenditure from state/local sources (CE1)", "skinny",
    "exp_cur_fed", "numeric", "expenditure", "NCES F-33 Survey", "CE2", "2016", "Current expenditure from federal sources (CE2)", "skinny",
    "exp_cur_resa", "numeric", "expenditure", "NCES F-33 Survey", "CE3", "2018", "Current expenditure by RESA on behalf of LEAs (CE3)", "skinny",
    "exp_cur_total", "numeric", "expenditure", "NCES F-33 Survey", "CE1 + CE2 + CE3", "2016", "Total current expenditure (CE1 + CE2 (+ CE3 when available))", "skinny",
    ...
    "exp_covid_total", "numeric", "expenditure", "NCES F-33 Survey", "AE1", "2020", "COVID-19 Federal Assistance Funds - Total expenditures (AE1)", "full",
    ...
    "fund_bal_debt_svc", "numeric", "debt", "NCES F-33 Survey", "W01", "2012", "Debt service fund cash and investments, FYE (W01)", "full",
    "fund_bal_bond", "numeric", "debt", "NCES F-33 Survey", "W31", "2012", "Bond fund cash and investments, FYE (W31)", "full",
    "fund_bal_other", "numeric", "debt", "NCES F-33 Survey", "W61", "2012", "Other funds cash and investments, FYE (W61)", "full",
